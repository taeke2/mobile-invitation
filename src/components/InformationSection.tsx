                ...
                >
                    <div className="relative">
                        <div className="overflow-hidden">
                            ...
                            >
                                {/* page 1 */}
                                <div className="w-1/2 shrink-0 px-6 pt-10 h-[400px] flex flex-col">
                                    <p className="font-noto-sans-kr text-[15px] font-semibold text-black">
                                        [ 단독 건물 좌석 안내 ]
                                    </p>

                                    <div className="h-[80px] flex items-center justify-center">
                                        <p className="font-gowun-batang text-[13px] font-bold text-center">
                                            1부 예식 후 식사는 1층,
                                            <br />
                                            예식과 동시에 식사는 2층
                                    ...
                                    <div className="flex-1 flex items-center justify-center">
                                        <p className="font-gowun-batang text-[13px] text-black text-center">
                                            저희 결혼식은 단독 건물에서
                                            <br />
                                            1부와 2부로 나뉘어 진행됩니다.
                                            <br />
                                ...
                                <div className="w-1/2 shrink-0 px-6 pt-10 h-[400px] flex flex-col">
                                    ...
                                    <div className="flex-1 flex items-center justify-center">
                                        <div className="font-gowun-batang text-[13px] text-black text-center">
